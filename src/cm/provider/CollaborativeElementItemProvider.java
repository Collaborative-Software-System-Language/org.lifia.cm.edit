...
/**
 * This is the item provider adapter for a {@link cm.CollaborativeElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollaborativeElementItemProvider extends ClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CollaborativeElementItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSincronoPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollaborativeElement_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollaborativeElement_description_feature", "_UI_CollaborativeElement_type"),
				 CmPackage.Literals.COLLABORATIVE_ELEMENT__DESCRIPTION,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Sincrono feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSincronoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollaborativeElement_sincrono_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollaborativeElement_sincrono_feature", "_UI_CollaborativeElement_type"),
				 CmPackage.Literals.COLLABORATIVE_ELEMENT__SINCRONO,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CmPackage.Literals.COLLABORATIVE_ELEMENT__ELEMENT_OPERATION);
		}
	...
	public String getText(Object object) {
		String label = ((CollaborativeElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CollaborativeElement_type") :
			getString("_UI_CollaborativeElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CollaborativeElement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CmPackage.Literals.COLLABORATIVE_ELEMENT__ELEMENT_OPERATION,
				 CmFactory.eINSTANCE.createElementOperation()));
	}
