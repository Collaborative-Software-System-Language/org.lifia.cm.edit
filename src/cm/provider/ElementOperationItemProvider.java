...
/**
 * This is the item provider adapter for a {@link cm.ElementOperation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementOperationItemProvider extends ClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ElementOperationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElementOperation_operation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementOperation_operation_feature", "_UI_ElementOperation_type"),
				 CmPackage.Literals.ELEMENT_OPERATION__OPERATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CmPackage.Literals.ELEMENT_OPERATION__OPERATION);
		}
	...
	/**
	 * This returns ElementOperation.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ElementOperation"));
	}
	...
	public String getText(Object object) {
		String label = ((ElementOperation)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ElementOperation_type") :
			getString("_UI_ElementOperation_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ElementOperation.class)) {
			case CmPackage.ELEMENT_OPERATION__OPERATION:
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == CmPackage.Literals.ELEMENT_OPERATION__OPERATION;
