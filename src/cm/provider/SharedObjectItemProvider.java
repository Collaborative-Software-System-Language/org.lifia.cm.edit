...
/**
 * This is the item provider adapter for a {@link cm.SharedObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SharedObjectItemProvider extends CollaborativeElementItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLockablePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Lockable feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLockablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SharedObject_lockable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SharedObject_lockable_feature", "_UI_SharedObject_type"),
				 CmPackage.Literals.SHARED_OBJECT__LOCKABLE,
				 true,
				 false,
				 false,
	...
	protected void addPersistentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SharedObject_persistent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SharedObject_persistent_feature", "_UI_SharedObject_type"),
				 CmPackage.Literals.SHARED_OBJECT__PERSISTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
