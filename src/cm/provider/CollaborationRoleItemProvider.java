...
/**
 * This is the item provider adapter for a {@link cm.CollaborationRole} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollaborationRoleItemProvider extends ClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CollaborationRoleItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollaborationRole_qualification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollaborationRole_qualification_feature", "_UI_CollaborationRole_type"),
				 CmPackage.Literals.COLLABORATION_ROLE__QUALIFICATION,
				 true,
				 false,
				 false,
	...
	protected void addUserPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollaborationRole_user_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollaborationRole_user_feature", "_UI_CollaborationRole_type"),
				 CmPackage.Literals.COLLABORATION_ROLE__USER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addAssignedRoleElementOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollaborationRole_assignedRoleElementOperation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollaborationRole_assignedRoleElementOperation_feature", "_UI_CollaborationRole_type"),
				 CmPackage.Literals.COLLABORATION_ROLE__ASSIGNED_ROLE_ELEMENT_OPERATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CmPackage.Literals.COLLABORATION_ROLE__ASSIGNED_ROLE_ELEMENT_OPERATION);
		}
	...
	/**
	 * This returns CollaborationRole.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CollaborationRole"));
	}
	...
	public String getText(Object object) {
		String label = ((CollaborationRole)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CollaborationRole_type") :
			getString("_UI_CollaborationRole_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CollaborationRole.class)) {
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == CmPackage.Literals.COLLABORATION_ROLE__ASSIGNED_ROLE_ELEMENT_OPERATION;
