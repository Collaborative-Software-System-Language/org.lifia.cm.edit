...
/**
 * This is the item provider adapter for a {@link cm.CollaborativeProcess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollaborativeProcessItemProvider extends ActivityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CollaborativeProcessItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollaborativeProcess_activity_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollaborativeProcess_activity_feature", "_UI_CollaborativeProcess_type"),
				 CmPackage.Literals.COLLABORATIVE_PROCESS__ACTIVITY,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns CollaborativeProcess.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CollaborativeProcess"));
	}
	...
	public String getText(Object object) {
		String label = ((CollaborativeProcess)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CollaborativeProcess_type") :
			getString("_UI_CollaborativeProcess_type") + " " + label;
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(UMLPackage.Literals.ACTIVITY__EDGE,
				 CmFactory.eINSTANCE.createCollaborativeProcessEdge()));

		newChildDescriptors.add
			(createChildParameter
				(UMLPackage.Literals.ACTIVITY__OWNED_NODE,
				 CmFactory.eINSTANCE.createCollaborativeActivityNode()));
	}
