...
/**
 * This is the item provider adapter for a {@link cm.HapticIndicator} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HapticIndicatorItemProvider extends ClassItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HapticIndicatorItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HapticIndicator_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HapticIndicator_kind_feature", "_UI_HapticIndicator_type"),
				 CmPackage.Literals.HAPTIC_INDICATOR__KIND,
				 true,
				 false,
				 false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HapticIndicator_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HapticIndicator_duration_feature", "_UI_HapticIndicator_type"),
				 CmPackage.Literals.HAPTIC_INDICATOR__DURATION,
				 true,
				 false,
				 false,
	...
	protected void addPeriodPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HapticIndicator_period_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HapticIndicator_period_feature", "_UI_HapticIndicator_type"),
				 CmPackage.Literals.HAPTIC_INDICATOR__PERIOD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addAmplitudePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HapticIndicator_amplitude_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HapticIndicator_amplitude_feature", "_UI_HapticIndicator_type"),
				 CmPackage.Literals.HAPTIC_INDICATOR__AMPLITUDE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addRepetitionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HapticIndicator_repetitions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HapticIndicator_repetitions_feature", "_UI_HapticIndicator_type"),
				 CmPackage.Literals.HAPTIC_INDICATOR__REPETITIONS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This returns HapticIndicator.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HapticIndicator"));
	}
	...
	public String getText(Object object) {
		String label = ((HapticIndicator)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HapticIndicator_type") :
			getString("_UI_HapticIndicator_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HapticIndicator.class)) {
