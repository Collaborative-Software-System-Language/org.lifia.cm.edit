...
/**
 * This is the item provider adapter for a {@link cm.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider extends ClassItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_collaborationRole_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_collaborationRole_feature", "_UI_User_type"),
				 CmPackage.Literals.USER__COLLABORATION_ROLE,
				 true,
				 false,
				 true,
				 null,
